...
cd libcroco-0.6.8
./configure --prefix=/home/ec2-user/build --disable-shared --enable-static && make && make install  && cd ..
...
make clean && ./configure --prefix=/home/ec2-user/build --without-gdiplus --disable-modules --with-included-loaders=yes --disable-shared --enable-static && make && make install && cd ..
