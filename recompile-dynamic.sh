...
#curl -OL ftp://ftp.redhat.com/pub/redhat/linux/enterprise/6Server/en/os/SRPMS/libcroco-0.6.2-5.el6.src.rpm
#rpmbuild --rebuild libcroco-0.6.2-5.el6.src.rpm 
#sudo rpm -i libcroco-0.6.2-5.el6.src.rpm
